<template>
  <v-container class="fill-height">
    <v-responsive class="d-flex text-center fill-height">
      ...
      <v-row class="d-flex align-center justify-center">
        <v-col cols="auto">
          <h2 style="color: #1783dc">สมัครใช้บริการ</h2>
        </v-col>
      </v-row>
      <v-row class="d-flex align-center justify-center">
        <v-col>
          <v-sheet class="d-flex flex-wrap" style="width:100%">
            <v-sheet class="ma-0 pa-0" style="width:100%">
              <v-text-field
                style="width: 100%"
                clearable
                ...
                type="number"
                v-model="phoneNo"
                placeholder="กรุณาระบุหมายเลขโทรศัพท์มือถือ"
                :rules="[required]"
                variant="outlined"
                @change="onChange()"
              ></v-text-field>
      ...
      <v-row class="d-flex align-center justify-center">
        <v-col cols="auto">
          ...
          <v-btn
            ...
            v-on:click="this.$router.push('/otp2')"
          >
            ถัดไป
          </v-btn>
          <!-- btn select -->
