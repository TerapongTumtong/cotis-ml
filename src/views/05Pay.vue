        ...
        <v-col cols="auto">
          ...
          <span
            style="
              ...
              font-weight: 700;
            "
            >ปกติคุณมีการจ่ายบิลแบบไหน 🧾</span
          >
        ...
        <v-row class="d-flex align-center justify-center">
          <v-col cols="6">
            <v-sheet class="d-flex flex-wrap">
              <v-sheet class="box-shadow flex-1-0 ma-0 pa-1">
                <!-- item 1 วางแผน -->
                <v-btn
                  :variant="flagbtn1"
                ...
                >
                  ...
                  />
                  <br />
                  <span style="color: black">วางแผนล่วงหน้า</span>
            ...
            <v-sheet class="d-flex flex-wrap">
              <v-sheet class="box-shadow flex-1-0 ma-0 pa-1">
                ...
                >
                  ...
                  />
                  <br />
                  <span style="color: black">จ่ายทันพอดี</span>
            ...
            <v-sheet class="d-flex flex-wrap">
              <v-sheet class="box-shadow flex-1-0 ma-0 pa-1">
                ...
                >
                  ...
                  />
                  <br />
                  <span style="color: black">จ่ายช้ามีค้างชำระบ้าง</span>
